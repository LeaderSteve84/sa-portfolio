...
@contacts_bp.route("/contact/<int:message_id>/edit", methods=['GET', 'POST'], strict_slashes=False)
...
@contacts_bp.route("/contact/<int:message_id>/delete", methods=['POST'], strict_slashes=False)
