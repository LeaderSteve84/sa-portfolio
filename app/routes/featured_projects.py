    ...
    if form.validate_on_submit():
        ...
        if form.errors != {}:
            for error_message in form.errors.values():
                flash(f"Error creating featured project: {error_message}", "error")
...
@featured_projects_bp.route("/featured_projects/<string:featured_project_id>/edit", methods=['GET'], strict_slashes=False)
@jwt_required()
...
@featured_projects_bp.route("/featured_projects/<string:featured_project_id>/update", methods=['POST'], strict_slashes=False)
...
@featured_projects_bp.route("/featured_projects/<string:featured_project_id>/delete", methods=['POST'], strict_slashes=False)
