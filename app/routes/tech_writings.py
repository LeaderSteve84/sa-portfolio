    ...
    if form.validate_on_submit():
        ...
        if form.errors != {}:
            for error_message in form.errors.values():
                flash(f"Error creating your technical writting: {error_message}", "error")
...
@tech_writings_bp.route("/writings/<string:writing_id>/edit", methods=['GET'], strict_slashes=False)
@jwt_required()
...
@tech_writings_bp.route("/writings/<string:writing_id>/update", methods=['POST'], strict_slashes=False)
...
@tech_writings_bp.route("/writings/<string:writing_id>/delete", methods=['POST'], strict_slashes=False)
